...
contract StarNotary is ERC721 {
    ...
    string private tokenName = "Gedu Star";
    string private tokenSymbol = "GEDU";
    ...
    function createStar(string memory _name, uint256 _tokenId) public {
        ...
        _approve(msg.sender, _tokenId); //need to approve the owner of the token
    }
    ...
    function buyStar(uint256 _tokenId) public payable {
        ...
        _approve(msg.sender, _tokenId); // needed to update
    ...
    function exchangeStars(uint256 _tokenId1, uint256 _tokenId2) public {
        ...
        require(
            ...
            "Not the owner for any token sent"
        );

        _approve(owner2, _tokenId1); // needed to update
        transferFrom(owner1, owner2, _tokenId1);
        _approve(owner1, _tokenId2); // needed to update
    ...
    function transferStar(address _to1, uint256 _tokenId) public {
        ...
        require(starOwner == msg.sender, "You are not the owner");

        _approve(_to1, _tokenId);
